import svgPaths from "./svg-5iwicwzeh7";
...
import { imgGroup } from "./svg-a1vbo";
...
function WhyContentList() {
  return (
    <div className="absolute content-stretch flex gap-[25px] items-center left-[69.15px] top-[2448.38px]" data-name="Why Content List">
      <Container />
      <Container1 />
      <Container2 />
      <Container3 />
