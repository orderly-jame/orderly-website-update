import svgPaths from "./svg-zqj7w2kw2e";
...
import { imgGroup } from "./svg-73ylg";
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Arrow left-circle">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_90_860)" id="Arrow left-circle">
          <g id="Icon">
...
function ArrowLeftCircle1() {
  return (
    <div className="relative size-[20px]" data-name="Arrow left-circle">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_90_878)" id="Arrow left-circle">
          <g id="Icon">
